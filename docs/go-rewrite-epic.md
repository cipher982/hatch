...
Status: Go 0.2.0 cut over; Phase 7 field soak in progress (2/50 eligible; 18 observed at the latest audit)
...
successes currently qualify. Python is retained only as the frozen
